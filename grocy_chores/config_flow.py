...
class GrocyChoresOptionsFlow(config_entries.OptionsFlow):
...
class GrocyChoresConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    VERSION = 6
    DOMAIN = DOMAIN
    ...
    def async_get_options_flow(
        ...
        return GrocyChoresOptionsFlow(config_entry)
    ...
    async def async_step_user(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema(
                {
                    vol.Required(
                        "api_url", default="https://localhost:9192"
                    ): cv.string,
